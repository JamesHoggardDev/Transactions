...
const Container = styled.div`
    ...
    &:hover {
        /* box-shadow: 0px 10px 8px -8px rgb(2, 66, 129); */
  ...
  return (
    <Container>
      ...
      <Status>
        ...
        {(() => {
          switch (status.level) {
            case 1: return <StatusIndicator color="#D50505" />;
            case 2: return <StatusIndicator color="#FFC42B" />;
            case 3: return <StatusIndicator color="#00ff00" />;
            default: return <StatusIndicator color="#dcdcdc" />;
          }
        })()}
      </Status>
